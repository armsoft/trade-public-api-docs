...
// Returns next page of additional addresses.
...
var response = await client.PostAsJsonAsync("/v1/directories/partners/additionaladdresses/list/nextpage", requestBody);
